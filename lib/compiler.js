...
var generateDocumentType = function(key, object, path, context) {
  ...
  //   innerContext.generatedField = context.generatedField;
  // }
...
var generateNestedArrayType = function(key, object, path, context) {
  ...
  // Generate generateField function
  context.functions.push(`
  ...
  var innerContext = {
    ...
    ruleIndex: context.ruleIndex,
    rules: context.rules,
    generatedField: f("generateField(path, %s)", topLevels.join(','))
  }
...
var generateExists = function(key, object, path, context) {
  ...
  // console.log("-------------------------------------------- generateExists" + index)
  // console.log(context.generatedField)
