...
var f = require('util').format,
  ...
  OfOneType = require('./ast').OfOneType;
...
var StringValidator = require('./validators/string'),
  ...
  OfOneValidator = require('./validators/of_one');
...
Compiler.prototype.compile = function(ast, options) {
  ...
  ***/}))
  ...
  } else if(ast instanceof OfOneType) {
    OfOneValidator.generate('object', ast, ['object'], context);
