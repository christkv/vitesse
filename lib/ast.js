...
var NullType = function(object) {
  if(!(this instanceof NullType)) return new NullType(object);
  this.object = object || {};
}
...
var EnumType = function(object) {
  if(!(this instanceof EnumType)) return new EnumType(object);
  this.object = object || {};
}
...
var DocumentType = function(object) {
  ...
  this.object = object || {};
  this.object.fields = this.object.fields || {};
}

var RecursiveReferenceType = function(object) {
  if(!(this instanceof RecursiveReferenceType)) return new RecursiveReferenceType(object);
  this.object = object || {};
}
...
exports.RecursiveReferenceType = RecursiveReferenceType;
