...
/**
 * @fileOverview The NotNode class represents a validation where the value must fail all included validation nodes
 */
 ...
 * 
 * @class
 * @return {NotNode} a NotNode instance.
 */
var NotNode = function(parent, field, options) {  
  options = options || {};
 ...
 * @return {NotNode}
 */
NotNode.prototype.setTypeCheck = function(typeCheck) {  
 ...
 * @ignore
 */
NotNode.prototype.setDefault = function(value) {
 ...
 *
 * @method
 * @param {array} validations all validation node that must fail for this node to be valid
 * @return {NotNode}
 */
NotNode.prototype.addValidations = function(validations) {
  var self = this;
 ...
 */
NotNode.prototype.path = function() {
 ...
 */
NotNode.prototype.generate = function(context) {
  // Set self
  var self = this;
  // Get the path
