...
//     } else if(rule instanceof AnyType) {
//     } else {
//       throw new Error('type not supported for additionalProperties match object generation');
//     }
//   } else if(schema.additionalProperties == false) {
//     console.log("------------------------------------ schema.additionalProperties")
//     // Generate a properties field test
//     var validationTemplate = M(function(){/***
//       console.log(propertyNames)
//     ***/});

//     context.functionCallContexts.push(Mark.up(validationTemplate, {

//     }));
//   }

//   // Return the functional call contexts
//   return context.functionCallContexts.length > 0 ? context.functionCallContexts : [];    
// }
