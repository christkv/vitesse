...
//  console.log("########################################## ALLOF CALLEd {{index}} :: " + currentErrors.length + " :: " + successfulValidations + " :: " + totalValidations)

        // Perform validations on object fields
        {{statements}}

//  console.log("########################################## ALLOF CALLEd {{index}} :: " + errors.length + " :: " + successfulValidations + " :: " + totalValidations)
  ...
  ***/});
  ...
  validations.forEach(function(rule) {
    ...
    if(rule instanceof ArrayType) {
      ...
      innerContext.generatedField = "path";
