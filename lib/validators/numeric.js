...
Numeric.validator = function(key, object, path, context) {
...
// //
// Numeric.validator = function(field, rule, options) {
//   var template = `
...
//     if(operator === '$gt') {
//       valueValidations.push(f('%s <= %s', fieldName, rule.validation[operator]));
...
//     } else {
//       throw new Error(f('validation operator %s is not supported by Numeric type', operator));
//     }
//   }
